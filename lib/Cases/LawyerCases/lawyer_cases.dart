...
class LawyerCasePage extends StatefulWidget {
  const LawyerCasePage({Key? key}) : super(key: key);

  @override
  State<LawyerCasePage> createState() => _LawyerCasePageState();
}

class _LawyerCasePageState extends State<LawyerCasePage> {
  ...
  void getData() async {
    try {
      List<Cases> fetchedData = await apiHandler.getLawyerCasesData();
      setState(() {
        data = fetchedData;
      });
    } catch (e) {
